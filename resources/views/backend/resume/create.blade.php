...
@section('content')
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h6 class="fw-bold">Tambah Education</h6>
                </div>
                ...
                @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="month" name="start" class="form-control" id="start" rows="3">
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-control" type="month" name="end_date" id="end_date_input">
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <label for="edu_description">Description</label>
                            <textarea name="edu_description" class="form-control" id="edu_description" rows="3"></textarea>
                        </div>
        ...
        <div class="col-md-6">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <h6 class="fw-bold">Tambah Experience</h6>
                </div>
                ...
                @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="end_option" id="ex_date_option">
                                <label class="form-check-label" for="ex_date_option">
                                    Specify Date
                                </label>
                                <input class="form-control" type="month" name="end_date" id="ex_date_input">
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <label for="exp_description">Description</label>
                            <textarea name="exp_description" class="form-control" id="exp_description" rows="3"></textarea>
                        </div>
                        <div class="float-end mb-3">
                            <button class="btn btn-primary me-1 btn-md" type="submit">Submit</button>
                            <button class="btn btn-secondary btn-md" type="reset">Reset</button>
